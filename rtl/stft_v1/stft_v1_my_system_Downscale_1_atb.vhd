...
entity stft_v1_my_system_Downscale_1_atb is
end;

architecture normal of stft_v1_my_system_Downscale_1_atb is

component stft_v1_my_system_Downscale_1 is
    port (
        in_1_v_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_c_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_3_real_d0_tpl : in std_logic_vector(25 downto 0);  -- sfix26_en17
        in_3_imag_d0_tpl : in std_logic_vector(25 downto 0);  -- sfix26_en17
        out_1_qv_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_2_qc_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_3_real_q0_tpl : out std_logic_vector(20 downto 0);  -- sfix21_en20
        out_3_imag_q0_tpl : out std_logic_vector(20 downto 0);  -- sfix21_en20
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component stft_v1_my_system_Downscale_1_stm is
    port (
...
signal in_3_real_d0_tpl_stm : STD_LOGIC_VECTOR (25 downto 0);
signal in_3_imag_d0_tpl_stm : STD_LOGIC_VECTOR (25 downto 0);
signal out_1_qv_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q0_tpl_stm : STD_LOGIC_VECTOR (20 downto 0);
signal out_3_imag_q0_tpl_stm : STD_LOGIC_VECTOR (20 downto 0);
signal in_1_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_2_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_3_real_d0_tpl_dut : STD_LOGIC_VECTOR (25 downto 0);
signal in_3_imag_d0_tpl_dut : STD_LOGIC_VECTOR (25 downto 0);
signal out_1_qv_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q0_tpl_dut : STD_LOGIC_VECTOR (20 downto 0);
signal out_3_imag_q0_tpl_dut : STD_LOGIC_VECTOR (20 downto 0);
...
dut : stft_v1_my_system_Downscale_1 port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
...
sim : stft_v1_my_system_Downscale_1_stm port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_real_d0_tpl_stm,
    in_3_imag_d0_tpl_stm,
