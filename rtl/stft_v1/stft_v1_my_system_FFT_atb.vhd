...
entity stft_v1_my_system_FFT_atb is
end;

architecture normal of stft_v1_my_system_FFT_atb is

component stft_v1_my_system_FFT is
    port (
        in_1_v_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_c_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_3_real_d_tpl : in std_logic_vector(17 downto 0);  -- sfix18_en17
        in_3_imag_d_tpl : in std_logic_vector(17 downto 0);  -- sfix18_en17
        out_1_qv_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_2_qc_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_3_real_q_tpl : out std_logic_vector(25 downto 0);  -- sfix26_en17
        out_3_imag_q_tpl : out std_logic_vector(25 downto 0);  -- sfix26_en17
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component stft_v1_my_system_FFT_stm is
    port (
...
signal in_3_real_d_tpl_stm : STD_LOGIC_VECTOR (17 downto 0);
signal in_3_imag_d_tpl_stm : STD_LOGIC_VECTOR (17 downto 0);
signal out_1_qv_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q_tpl_stm : STD_LOGIC_VECTOR (25 downto 0);
signal out_3_imag_q_tpl_stm : STD_LOGIC_VECTOR (25 downto 0);
signal in_1_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_2_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_3_real_d_tpl_dut : STD_LOGIC_VECTOR (17 downto 0);
signal in_3_imag_d_tpl_dut : STD_LOGIC_VECTOR (17 downto 0);
signal out_1_qv_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q_tpl_dut : STD_LOGIC_VECTOR (25 downto 0);
signal out_3_imag_q_tpl_dut : STD_LOGIC_VECTOR (25 downto 0);
...
dut : stft_v1_my_system_FFT port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_real_d_tpl_stm,
    in_3_imag_d_tpl_stm,
...
sim : stft_v1_my_system_FFT_stm port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_real_d_tpl_stm,
    in_3_imag_d_tpl_stm,
