...
if {! [file exists $base_dir/stft_v1_my_system]} {
    file delete -force $base_dir/stft_v1_my_system
}

project new $base_dir stft_v1_my_system
...
if {($compiled_subscripted) || ([info exists quartus_dir] && [file isdirectory $quartus_dir])} {
    ...
    do "$base_dir/stft_v1/stft_v1_my_system_fpc.do"
} else {
...
project addfile $base_dir/stft_v1/stft_v1_my_system.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_Demux_Normalize.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_Downscale_1.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_Downscale_2.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_FFT.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_IFFT.sv systemverilog
project addfile $base_dir/stft_v1/stft_v1_my_system_Mux_Windowing.sv systemverilog
...
puts {vcom -quiet -O0 $base_dir/stft_v1/stft_v1_my_system_atb.vhd}
project addfile $base_dir/stft_v1/stft_v1_my_system_atb.vhd vhdl
project addfile $base_dir/stft_v1/stft_v1_my_system_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_q0_im} mismatch] == 0 && $mismatch } {
                report_mismatch q0_im $cyclenum
            }
            if { [catch {exa mismatch_q0_re} mismatch] == 0 && $mismatch } {
                report_mismatch q0_re $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps stft_v1_my_system_atb $ll
    do $base_dir/stft_v1/stft_v1_my_system_atb.wav.do
