...
-- VHDL created from stft_v1_my_system_Demux_Normalize
...
entity stft_v1_my_system_Demux_Normalize_atb is
end;

architecture normal of stft_v1_my_system_Demux_Normalize_atb is

component stft_v1_my_system_Demux_Normalize is
    port (
        in_1_v_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_c_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_3_real_d0_tpl : in std_logic_vector(17 downto 0);  -- sfix18_en17
        in_3_imag_d0_tpl : in std_logic_vector(17 downto 0);  -- sfix18_en17
        out_1_qv_tpl : out std_logic_vector(0 downto 0);  -- ufix1
        out_2_qc_tpl : out std_logic_vector(7 downto 0);  -- ufix8
        out_3_real_q0_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en15
        out_3_imag_q0_tpl : out std_logic_vector(15 downto 0);  -- sfix16_en15
        clk : in std_logic;
        areset : in std_logic
    );
end component;

component stft_v1_my_system_Demux_Normalize_stm is
    port (
        in_1_v_tpl_stm : out std_logic_vector(0 downto 0);
        in_2_c_tpl_stm : out std_logic_vector(7 downto 0);
        in_3_real_d0_tpl_stm : out std_logic_vector(17 downto 0);
        in_3_imag_d0_tpl_stm : out std_logic_vector(17 downto 0);
        out_1_qv_tpl_stm : out std_logic_vector(0 downto 0);
        out_2_qc_tpl_stm : out std_logic_vector(7 downto 0);
        out_3_real_q0_tpl_stm : out std_logic_vector(15 downto 0);
        out_3_imag_q0_tpl_stm : out std_logic_vector(15 downto 0);
        clk : out std_logic;
...
signal in_3_real_d0_tpl_stm : STD_LOGIC_VECTOR (17 downto 0);
signal in_3_imag_d0_tpl_stm : STD_LOGIC_VECTOR (17 downto 0);
signal out_1_qv_tpl_stm : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_stm : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q0_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_imag_q0_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_1_v_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal in_2_c_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal in_3_real_d0_tpl_dut : STD_LOGIC_VECTOR (17 downto 0);
signal in_3_imag_d0_tpl_dut : STD_LOGIC_VECTOR (17 downto 0);
signal out_1_qv_tpl_dut : STD_LOGIC_VECTOR (0 downto 0);
signal out_2_qc_tpl_dut : STD_LOGIC_VECTOR (7 downto 0);
signal out_3_real_q0_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal out_3_imag_q0_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
checkChannelIn_cunroll_x : process (clk, areset, in_3_real_d0_tpl_dut, in_3_real_d0_tpl_stm, in_3_imag_d0_tpl_dut, in_3_imag_d0_tpl_stm)
begin
END PROCESS;


-- Channelized data out check
checkChannelOut_cunroll_x : process (clk, areset, out_3_real_q0_tpl_dut, out_3_real_q0_tpl_stm, out_3_imag_q0_tpl_dut, out_3_imag_q0_tpl_stm)
...
dut : stft_v1_my_system_Demux_Normalize port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
...
sim : stft_v1_my_system_Demux_Normalize_stm port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_real_d0_tpl_stm,
    in_3_imag_d0_tpl_stm,
