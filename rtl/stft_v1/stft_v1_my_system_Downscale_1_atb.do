...
if {! [file exists $base_dir/stft_v1_my_system_Downscale_1]} {
    file delete -force $base_dir/stft_v1_my_system_Downscale_1
}

project new $base_dir stft_v1_my_system_Downscale_1
...
if {($compiled_subscripted) || ([info exists quartus_dir] && [file isdirectory $quartus_dir])} {
    ...
    do "$base_dir/stft_v1/stft_v1_my_system_Downscale_1_fpc.do"
} else {
...
puts {vcom -quiet -O0 $base_dir/stft_v1/stft_v1_my_system_Downscale_1_atb.vhd}
project addfile $base_dir/stft_v1/stft_v1_my_system_Downscale_1_atb.vhd vhdl
project addfile $base_dir/stft_v1/stft_v1_my_system_Downscale_1_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps stft_v1_my_system_Downscale_1_atb $ll
    do $base_dir/stft_v1/stft_v1_my_system_Downscale_1_atb.wav.do
