...
if {! [file exists $base_dir/stft_v1_my_system_Demux_Normalize]} {
    file delete -force $base_dir/stft_v1_my_system_Demux_Normalize
}

project new $base_dir stft_v1_my_system_Demux_Normalize
...
if {($compiled_subscripted) || ([info exists quartus_dir] && [file isdirectory $quartus_dir])} {
    ...
    do "$base_dir/stft_v1/stft_v1_my_system_Demux_Normalize_fpc.do"
} else {
...
puts {vcom -quiet -O0 $base_dir/stft_v1/stft_v1_my_system_Demux_Normalize_atb.vhd}
project addfile $base_dir/stft_v1/stft_v1_my_system_Demux_Normalize_atb.vhd vhdl
project addfile $base_dir/stft_v1/stft_v1_my_system_Demux_Normalize_stm.vhd vhdl
...
if {$vcomfailed == 0} {
    onbreak {
        ...
        if {$regOK == 1} {
            ...
            if { [catch {exa mismatch_out_3_real_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_real_q0_tpl $cyclenum
            }
            if { [catch {exa mismatch_out_3_imag_q0_tpl} mismatch] == 0 && $mismatch } {
                report_mismatch out_3_imag_q0_tpl $cyclenum
            }
        } else {
    ...
    eval vsim -quiet -suppress 14408 -error 3473 -msgmode both -voptargs="+acc" -t ps stft_v1_my_system_Demux_Normalize_atb $ll
    do $base_dir/stft_v1/stft_v1_my_system_Demux_Normalize_atb.wav.do
