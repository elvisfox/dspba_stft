...
-- VHDL created from stft_v1_my_system_Mux_Windowing
...
entity stft_v1_my_system_Mux_Windowing_atb is
end;

architecture normal of stft_v1_my_system_Mux_Windowing_atb is

component stft_v1_my_system_Mux_Windowing is
    port (
        in_1_v_tpl : in std_logic_vector(0 downto 0);  -- ufix1
        in_2_c_tpl : in std_logic_vector(7 downto 0);  -- ufix8
        in_3_real_d0_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en15
        in_3_imag_d0_tpl : in std_logic_vector(15 downto 0);  -- sfix16_en15
...
component stft_v1_my_system_Mux_Windowing_stm is
    port (
        in_1_v_tpl_stm : out std_logic_vector(0 downto 0);
        in_2_c_tpl_stm : out std_logic_vector(7 downto 0);
        in_3_real_d0_tpl_stm : out std_logic_vector(15 downto 0);
        in_3_imag_d0_tpl_stm : out std_logic_vector(15 downto 0);
...
signal in_3_real_d0_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_imag_d0_tpl_stm : STD_LOGIC_VECTOR (15 downto 0);
...
signal in_3_real_d0_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
signal in_3_imag_d0_tpl_dut : STD_LOGIC_VECTOR (15 downto 0);
...
dut : stft_v1_my_system_Mux_Windowing port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
...
sim : stft_v1_my_system_Mux_Windowing_stm port map (
    in_1_v_tpl_stm,
    in_2_c_tpl_stm,
    in_3_real_d0_tpl_stm,
    in_3_imag_d0_tpl_stm,
